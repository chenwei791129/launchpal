# dmg-packaging Specification

## Purpose

Define the DMG packaging workflow for LaunchPal, replacing the previous `.app.gz` tar archive with a proper macOS DMG disk image that provides a drag-to-install experience for end users.
